...
// Will need to update this to a server send and a client send
// servertx: send out what each node should work on (as well as each starting point) OR send completion notifications
